        ...
        <div className="flex items-center justify-center p-5">
          <div className="max-w-xl p-8 text-center text-gray-800 bg-white shadow-xl lg:max-w-3xl rounded-3xl lg:p-12">
            <h3 className="text-2xl font-bold">
              Thanks for signing up for My Todo!
            </h3>
            ...
            <p className="text-sm">
              A verification link has been sent to your registered email. Please
              verify your email before continuing.
            </p>
            <p className="mt-2 text-sm">
              {`If you've already verified, you can proceed to `}
              <a className="text-blue-500 underline" href="/auth/login">
                Login
              </a>
              .
            </p>
            <h1 className="my-4 font-bold text-lg">(or)</h1>
            <p className=" text-sm">
              To complete the registration process, simply click the below
              button:
            </p>
            <div className="mt-4">
